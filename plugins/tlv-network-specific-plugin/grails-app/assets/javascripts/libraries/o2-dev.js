var createImageLayerSourceO2Dev = createImageLayerSource;
createImageLayerSource = function( layer ) {
	if ( layer.library == "o2-dev" ) {
	...
	else { return createImageLayerSourceO2Dev( layer ); }
}

var pageLoadO2Dev = pageLoad;
pageLoad = function() {
	pageLoadO2Dev();

	tlv.libraries[ "o2-dev"].searchLibrary = function( searchParams ) {
		var library = tlv.libraries[ "o2-dev"];
